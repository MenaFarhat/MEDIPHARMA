...
//import 'package:pharmacy_project2/domain/params/log_in_parameters.dart';
//import 'package:pharmacy_project2/presentation/manager/log_in_pharmacy_cubit.dart';

// ignore: must_be_immutable
class LogInPage extends StatefulWidget {
  bool showButton;
  LogInPage({required this.showButton, super.key});
      ...
      appBar: CustomAppBar(
        ...
        leading: Row(
          children: [
            ...
            Padding(
              padding:
                  EdgeInsets.only(left: widget.showButton == true ? 10 : 20),
              child: Text(
                'Log in',
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                _buildRowNameAndIcon(Icons.lock, 'Password', 8, 0),
                _buildTextFormField(
